...
import { Code, Mail, Lock, AlertCircle, ArrowRight, CheckCircle2 } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Create your account and start getting code explanations
          </p>
        </div>
          ...
          {success ? (
            <div className="flex flex-col items-center text-center py-6 space-y-4">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                ...
                Please click the link to confirm your signup.
              </p>
              <Link
                to="/login"
                className="mt-6 flex items-center gap-2 text-sm font-semibold text-indigo-400 hover:text-indigo-300 transition-colors"
              >
